## Here's a PowerShell script that automatically manages dynamic departmental group memberships in Active Directory based on the Department attribute.
## The script adds users to their respective departmental groups and removes them from old groups if their department changes:
